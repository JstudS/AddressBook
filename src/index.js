...
class UI {
    ...
    static addToAddressList(address) {
        ...
        tableRow.innerHTML = `
            <td>${address.id}</td>
            <td>
                <span class="addressing-name">${address.addrName}</span><br><span class="address">${address.streetAddr} ${address.postCode} ${address.city}
    ...
    static showModal() {
        ...
        document.getElementById('modal-btn').innerHTML = `<button type="submit" id="save-btn">Save</button>`
    }
